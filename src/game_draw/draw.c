...
static void	draw_ray(t_game *game, int x)
{
	...
	wall_x = game->player.x + game->ray.ray_dir_x * game->ray.distance_to_wall
		* 64;
	wall_y = game->player.y + game->ray.ray_dir_y * game->ray.distance_to_wall
		* 64;
